            ...
            <div className="theNav">
                <Nav>
                    <NavItem className="theNavItems">
                        <Link to="/"><Button className="theNavButtons" outline color="primary">Organiz.er</Button></Link>  
                    </NavItem>
                    <NavItem className="theNavItems">
                        <Link to="/to-do"><Button className="theNavButtons" outline color="primary">To-do's</Button></Link>
                    </NavItem>
                    <NavItem className="theNavItems">
                        <Link to="/studyWithMe"><Button className="theNavButtons" outline color="primary">Study With Me</Button></Link>
                    </NavItem>
                    <NavItem className="theNavItems">
                        <Link to="/productivityTracker"><Button className="theNavButtons" outline color="primary">Productivity Tracker</Button></Link>        
                    </NavItem>
